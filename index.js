...
/*🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: Nested function can access the variable internal because nested functions act as a closure that closes the outer scope variable 
within its scope even after the puter function is executed. */
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const smallPopulation = zooAnimals.filter((item) => {
  ...
  */
  ...
  function USApop(array){
    const reducedArr = zooAnimals.reduce((accumulator, item) => 
    {
